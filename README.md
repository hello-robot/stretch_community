...
| Group                                                        | Description                                                  | Repo                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Prof. Zackory Erickson @ Carnegie Mellon University](https://zackory.com/) | Assistive Gym is a simulation system compatible with OpenAI Gym for assistive-robotics tasks. It includes a simulation of Stretch. Assistive Gym originated in the [Healthcare Robotics Lab at Georgia Tech](http://healthcare-robotics.com/). | [assistive-gym](https://github.com/Healthcare-Robotics/assistive-gym) |
