...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Bahl, Gupta & Pathak@Carnegie Mellon University](https://www.cs.cmu.edu/~dpathak/) |WHIRL: Human-to-Robot Imitation in the Wild. With WHIRL the CMU team demonstrats one-shot, generalization of learning from human video, including 20 different manipulation tasks in the wild.|[human2robot](https://human2robot.github.io/)|
