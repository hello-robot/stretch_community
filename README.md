...
| Group                                                        | Description                                                  | Repo                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Grady, Collins, Brahmbhatt, Twigg, Tang, Hays, and Kemp @ Georgia Tech](https://sites.gatech.edu/hrl/) |Publication: [Visual Pressure Estimation and Control for Soft Robotic Grippers, Conference on Intelligent Robots and Systems, (IROS), 2022](https://arxiv.org/abs/2204.07268)|[*Code Coming Soon*](https://github.com/Healthcare-Robotics/VPEC)|
